...
export default defineConfig({
	dialect: 'postgresql',
	// Drie bestanden: de winkel, de accounts en wat klanten bewaren. Bewust gescheiden, zie
	// src/db/auth-schema.ts.
	schema: ['./src/db/schema.ts', './src/db/auth-schema.ts', './src/db/klanten-schema.ts'],
	out: './drizzle',
	dbCredentials: { url },
	migrations: {
